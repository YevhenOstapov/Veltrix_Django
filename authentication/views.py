...
class login2View(View,LoginRequiredMixin):
    def get(self , request):
        greeting = {}       
...
class Register2View(View,LoginRequiredMixin):
    def get(self , request):
        greeting = {}       
...
class RecoverpasswordView(View,LoginRequiredMixin):
    def get(self , request):
        greeting = {}       
...
class Recoverpassword2View(View,LoginRequiredMixin):
    def get(self , request):
        greeting = {}       
...
class LockscreenView(View,LoginRequiredMixin):
    def get(self , request):
        greeting = {}       
...
class Lockscreen2View(View,LoginRequiredMixin):
    def get(self , request):
        greeting = {}       
